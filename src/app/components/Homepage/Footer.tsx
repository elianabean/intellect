    ...
    return (
        <div className="w-[100vw] bg-white flex flex-col pt-[70px] pb-[18px] px-[100px] justify-center items-center z-10">
            ...
            <div className="flex flex-row items-center justify-start w-full">
                <div className="w-[65px] h-[65px]  bg-[#00A727] rounded-full flex items-center justify-center mr-[18px]"><Image src="/icons/rightArrow2.svg" alt="right arrow" width={17} height={28}/></div>
                <p className="text-[#0B1215] font-inter text-3xl font-semibold leading-[150%]">Intellect.ai.team@gmail.com</p>
            </div>
