    ...
    return (
        <div className="flex flex-col w-[100vw] h-[100vh] relative justify-between items-center">
            ...
            <div className="z-10 absolute flex flex-col justify-center items-center left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]">
                <Image src="/images/logoBig.png" alt="logo" width={180} height={180} className="-mb-8"></Image>
                <p className="px-4 text-[#00A727] text-center font-inter text-[70px] italic font-black leading-[150%] bg-gradient-to-r from-[#00A727] to-[rgba(78,219,210,0.60)]  bg-clip-text [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] [text-fill-color: transparent]">Intellect AI</p>
                <p className="mt-[4px] mb-[96px] w-[413px] text-[#162126] text-center font-inter text-[35px] font-semibold leading-[150%]">The ultimate AI financial management helper</p>
            ...
            <p className="z-10 text-center font-inter text-xl font-bold leading-[150%] text-[#6B7280]">Trusted By Students At The <span className="text-[#00A727]">Top Universities</span></p>
