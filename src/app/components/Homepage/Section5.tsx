        ...
        <div className="flex flex-row w-[100vw] h-[100vh] relative justify-center items-center bg-transparent overflow-y-visible overflow-x-clip">
            ...
            <div className="flex flex-col justify-center items-center w-[50vw]  h-full z-10">
                <div className="flex flex-col justify-center items-center">
                    <Image src="/images/image-15.png" alt="Screenshot of Intellect Dashboard" width={350} height={224.17} className="shadow-[1px_0px_4px_3px_rgba(0,0,0,0.25)] rounded-[15px] border-solid border-[#C4D8C4]  " data-aos="fade-up"></Image>
                    <Image src="/images/image-16.png" alt="Screenshot of Intellect Dashboard" width={350} height={224.17} className="shadow-[1px_0px_4px_3px_rgba(0,0,0,0.25)] rounded-[15px] border-solid border-[#C4D8C4] relative top-[-25px] left-[-85px]" data-aos="fade-up"></Image>
                </div>
            </div>
        </div>
    );
