      ...
      <div className="h-full min-h-[100vh] w-[100vw] pl-36 pr-4 flex flex-row flex-wrap justify-center items-start gap-[45px] py-[116px]">
        <div className="shrink-0 [background:rgba(252,251,255,0.80)] rounded-[30px] border-4 border-solid border-[#2A3A28] w-[60%] py-[32px] px-[60px]">
            ...
            <div className="flex flex-col items-start mt-[35px] mb-2">
              <p className="text-[#2A3A28] font-raleway text-lg font-bold leading-[150%] mb-2">Monday</p>
              <FileUpload></FileUpload>

              <p className="text-[#2A3A28] font-raleway text-lg font-bold leading-[150%] mt-[7px] mb-2">Tuesday</p>
              <FileUpload></FileUpload>

              <p className="text-[#2A3A28] font-raleway text-lg font-bold leading-[150%] mt-[7px] mb-2">Wednesday</p>
              <FileUpload></FileUpload>

              <p className="text-[#2A3A28] font-raleway text-lg font-bold leading-[150%] mt-[7px] mb-2">Thursday</p>
              <FileUpload></FileUpload>

              <p className="text-[#2A3A28] font-raleway text-lg font-bold leading-[150%] mt-[7px] mb-2">Friday!!</p>
              <FileUpload></FileUpload>

              <p className="text-[#2A3A28] font-raleway text-lg font-bold leading-[150%] mt-[7px] mb-2">Saturday</p>
              <FileUpload></FileUpload>

              <p className="text-[#2A3A28] font-raleway text-lg font-bold leading-[150%] mt-[7px] mb-2">Sunday</p>
              <FileUpload></FileUpload>
